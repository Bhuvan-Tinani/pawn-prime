...
public class OtpService {
	...
	private String whatsappNumber; // This will be your Twilio WhatsApp number (e.g., "whatsapp:+14155238886")
	
//	@Value("${twilio.sms.number}")
//	private String smsNumber; // Not used for WhatsApp
	...
	public boolean sendOtp(String phoneNumber) {
		try {
			...
			// --- CHANGE IS HERE: Use "whatsapp:" prefix and whatsappNumber ---
			Message message = Message.creator(
					new PhoneNumber("whatsapp:" + phoneNumber), 	 // ✅ Recipient's number with 'whatsapp:' prefix
					new PhoneNumber("whatsapp:"+whatsappNumber), 	// ✅ Your Twilio WhatsApp-enabled number
					"Your OTP is: " + otp
				).create();
			// -----------------------------------------------------------------
